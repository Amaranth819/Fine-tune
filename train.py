...
model = DDPG.load(os.path.join(old_log_path, 'DDPG'), env, verbose = 1, learning_rate = lr, tensorboard_log = tb_log, batch_size = batch_size, replay_buffer_class = HerReplayBuffer)
